...
switch (platform) {
    ...
    switch (arch) {
      case "arm64":
        localFileExisted = existsSync(
          join(__dirname, "css-inline.android-arm64.node"),
        );
        try {
          if (localFileExisted) {
      ...
      case "arm":
        localFileExisted = existsSync(
          join(__dirname, "css-inline.android-arm-eabi.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "darwin":
    localFileExisted = existsSync(
      join(__dirname, "css-inline.darwin-universal.node"),
    );
    try {
      if (localFileExisted) {
    ...
    switch (arch) {
      case "x64":
        localFileExisted = existsSync(
          join(__dirname, "css-inline.darwin-x64.node"),
        );
        try {
          if (localFileExisted) {
  ...
  case "freebsd":
    ...
    localFileExisted = existsSync(
      join(__dirname, "css-inline.freebsd-x64.node"),
    );
    try {
      if (localFileExisted) {
